        ...
        if (tecla == 224) { // Tecla especial
            ...
            case 4: // Guardar Archivo
            {
                ...
                if (selGuardado == 0) { // Respaldo (.bak)
                    banco.guardarCuentasEnArchivo(nombreArchivo);
                }
            ...
            case 5: // Recuperar Archivo
            {
                ...
                std::string opcionesCarga[] = { "Respaldo (.bak)", "Archivo cifrado (.bin)", "Cancelar" };
                ...
                if (selCarga == 0) { // Respaldo (.bak)
                    banco.cargarCuentasDesdeArchivo(nombreArchivo);
                }
                else if (selCarga == 1) { // Archivo cifrado (.bin)
            ...
            if (seleccion == numOpciones - 1) // Si selecciono "Salir"
                break;
