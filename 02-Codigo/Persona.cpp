...
int Persona::buscarPersonaPorCriterio(const std::string& criterio, const std::string& valorStr, double valorNum) const {
    ...
    NodoCuentaAhorros* actualAhorros = cabezaAhorros;
    while (actualAhorros) {
    ...
    NodoCuentaCorriente* actualCorriente = cabezaCorriente;
...
int Persona::buscarPersonaPorCuentas(const string& numeroCuenta) const {
    ...
    NodoCuentaAhorros* actualA = cabezaAhorros;
    while (actualA) {
        if (!actualA->cuenta || 
    ...
    NodoCuentaCorriente* actualC = cabezaCorriente;
    while (actualC) {
...
int Persona::guardarCuentasAhorro(std::ofstream& archivo) const {
	...
	int contador = 0;
	NodoCuentaAhorros* actual = cabezaAhorros;
...
int Persona::guardarCuentasCorriente(std::ofstream& archivo) const {
	...
	int contador = 0;
	NodoCuentaCorriente* actual = cabezaCorriente;
