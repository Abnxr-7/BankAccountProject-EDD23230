...
public:
	...
	NodoCuentaAhorros* getCabezaAhorros() const { return cabezaAhorros; }
	NodoCuentaCorriente* getCabezaCorriente() const { return cabezaCorriente; }
	...
	bool crearYAgregarCuentaAhorros() {
	    // Verificar limite
	    if (numAhorros >= 5) {
	...
	bool crearYAgregarCuentaCorriente() {
